  ...
  return (
    <header
      style={{
        ...
        borderBottom: scrolled ? "1px solid rgba(95, 61, 196, 0.12)" : "1px solid transparent",
        ...
        <nav className="hidden md:flex items-center gap-8">
          {links.map(({ href, label }) => (
            <Link
              ...
              onMouseEnter={e => (e.currentTarget.style.color = "var(--tone-900)")}
              onMouseLeave={e => (e.currentTarget.style.color = "var(--tone-700)")}
            >
              {label}
            </Link>
          ))}
